...
const sampleFindings: Record<Scenario, readonly Finding[]> = {
  drift: [
    ...
    },
    {
      ...
      tone: "blocker",
      eyebrow: "Must fix · Manifest ↔ evidence",
  ...
  aligned: [
    ...
    {
      id: "domain-ownership",
      rule: "DOMAIN_OWNERSHIP_CONFIRM_MANUALLY",
      tone: "manual",
      eyebrow: "Confirm manually · External ownership",
      title: "The technical domain set aligns. Ownership still requires external confirmation.",
      summary:
        "ScopeParity can compare the recorded hosts, but it does not request Search Console credentials or infer account ownership.",
      codeValue: "homepage + privacy + redirect hosts align",
      manifestValue: "domain_ownership_verified: false",
      action: "Confirm ownership with the same Google account and role used for the intended submission.",
      reference: "Google: Verification requirements",
    },
  ],
};
  ...
  return (
    <div className="sample-shell">
      ...
      <p className="sample-disclosure">
        This interactive walkthrough uses invented domains, names, routes, and scopes. It runs entirely in your
        browser and is not generated by a live scan. Inspect the reproducible reports below for current engine output.
      </p>
    </div>
  );
}
    ...
    <>
      ...
      <div className="page" id="top">
        ...
        >
          ...
          <meta itemProp="softwareVersion" content="0.1.4" />
          <meta
          ...
          <section className="section section--sample" id="sample" aria-labelledby="sample-title">
            ...
            <SampleReport />
            <aside className="sample-real-examples" aria-label="Reproducible public examples">
              <div>
                <span className="section-index">REAL ENGINE OUTPUT</span>
                <strong>Prefer proof you can rerun?</strong>
                <p>Inspect three synthetic before/after projects, their manifests, source files, and current CLI reports.</p>
              </div>
              <a href="/examples/" data-event="sample_public_examples_click">
                Open reproducible examples <ArrowIcon />
              </a>
            </aside>
          </section>
